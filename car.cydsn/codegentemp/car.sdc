...
# Date: Tue, 15 Nov 2016 03:57:13 GMT
#set_units -time ns
...
create_generated_clock -name {UART_LIDAR_IntClock} -source [get_pins {ClockBlock/clk_sync}] -edges {1 27 53} -nominal_period 1083.3333333333333 [list [get_pins {ClockBlock/dclk_glb_4}]]
create_generated_clock -name {UART_net_IntClock} -source [get_pins {ClockBlock/clk_sync}] -edges {1 27 53} -nominal_period 1083.3333333333333 [list [get_pins {ClockBlock/dclk_glb_5}]]

set_false_path -from [get_pins {__ONE__/q}]

# Component constraints for D:\robot\code\robot-car\car.cydsn\TopDesign\TopDesign.cysch
# Project: D:\robot\code\robot-car\car.cydsn\car.cyprj
# Date: Tue, 15 Nov 2016 03:56:49 GMT
