...
void PWM_LED_Stop(void) 
{
    ...
    *******************************************************************************/
    ...
    {
        CY_SET_REG16(PWM_LED_COUNTER_LSB_PTR, counter);
    }
    ...
    *******************************************************************************/
    uint16 PWM_LED_ReadCounter(void) 
    {
        ...
        return (CY_GET_REG16(PWM_LED_CAPTURE_LSB_PTR));
    }
...
void PWM_LED_WritePeriod(uint16 period) 
{
    ...
    #else
        CY_SET_REG16(PWM_LED_PERIOD_LSB_PTR, period);
    #endif /* (PWM_LED_UsingFixedFunction) */
}
    ...
    *******************************************************************************/
                                       ...
                                       
    {
        ...
        #else
            CY_SET_REG16(PWM_LED_COMPARE1_LSB_PTR, compare);
        #endif /* (PWM_LED_UsingFixedFunction) */
            ...
            #else
                CY_SET_REG16(PWM_LED_COMPARE2_LSB_PTR, (compare + 1u));
            #endif /* (PWM_LED_UsingFixedFunction) */
    ...
    *******************************************************************************/
    ...
    {
        #if(PWM_LED_UsingFixedFunction)
            return ((uint16)CY_GET_REG16(PWM_LED_COMPARE1_LSB_PTR));
        #else
            return (CY_GET_REG16(PWM_LED_COMPARE1_LSB_PTR));
        #endif /* (PWM_LED_UsingFixedFunction) */
    }
    ...
    *******************************************************************************/
    ...
    {
        return (CY_GET_REG16(PWM_LED_COMPARE2_LSB_PTR));
    }
...
{
    #if(PWM_LED_UsingFixedFunction)
        return ((uint16)CY_GET_REG16(PWM_LED_PERIOD_LSB_PTR));
    #else
        return (CY_GET_REG16(PWM_LED_PERIOD_LSB_PTR));
    #endif /* (PWM_LED_UsingFixedFunction) */
}
