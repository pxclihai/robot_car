...
// PWM_v3_30(CaptureMode=0, Clock_CheckTolerance=true, Clock_desired_freq=12, Clock_desired_freq_unit=6, Clock_divisor=1, Clock_FractDividerDenominator=0, Clock_FractDividerNumerator=0, Clock_FractDividerUsed=false, Clock_is_direct=false, Clock_is_divider=false, Clock_is_freq=true, Clock_minus_tolerance=5, Clock_ph_align_clock_id=, Clock_ph_align_clock_name=, Clock_plus_tolerance=5, Clock_source_clock_id=, Clock_source_clock_name=, Compare1_16=false, Compare1_8=false, Compare2_16=true, Compare2_8=false, CompareStatusEdgeSense=true, CompareType1=1, CompareType1Software=0, CompareType2=1, CompareType2Software=0, CompareValue1=900, CompareValue2=900, CONTROL3=0, ControlReg=true, CtlModeReplacementString=SyncCtl, CyGetRegReplacementString=CY_GET_REG16, CySetRegReplacementString=CY_SET_REG16, DeadBand=0, DeadBand2_4=0, DeadBand256=0, DeadBandUsed=0, DeadTime=1, DitherOffset=0, EnableMode=0, FF16=false, FF8=false, FixedFunction=false, FixedFunctionUsed=0, InterruptOnCMP1=false, InterruptOnCMP2=false, InterruptOnKill=false, InterruptOnTC=false, IntOnCMP1=0, IntOnCMP2=0, IntOnKill=0, IntOnTC=0, KillMode=0, KillModeMinTime=0, MinimumKillTime=1, OneCompare=false, Period=1000, PWMMode=1, PWMModeCenterAligned=0, RegDefReplacementString=reg16, RegSizeReplacementString=uint16, Resolution=16, RstStatusReplacementString=sSTSReg_rstSts, RunMode=0, Status=false, TermMode_capture=0, TermMode_clock=0, TermMode_cmp_sel=0, TermMode_enable=0, TermMode_interrupt=0, TermMode_kill=0, TermMode_ph1=0, TermMode_ph2=0, TermMode_pwm=0, TermMode_pwm1=0, TermMode_pwm2=0, TermMode_reset=0, TermMode_tc=0, TermMode_trigger=0, TermVisibility_capture=false, TermVisibility_clock=true, TermVisibility_cmp_sel=false, TermVisibility_enable=false, TermVisibility_interrupt=false, TermVisibility_kill=false, TermVisibility_ph1=false, TermVisibility_ph2=false, TermVisibility_pwm=false, TermVisibility_pwm1=true, TermVisibility_pwm2=true, TermVisibility_reset=true, TermVisibility_tc=true, TermVisibility_trigger=false, TriggerMode=0, UDB16=true, UDB8=false, UseControl=true, UseInterrupt=false, UseStatus=false, VerilogSectionReplacementString=sP16, CY_API_CALLBACK_HEADER_INCLUDE=#include "cyapicallbacks.h", CY_COMPONENT_NAME=PWM_v3_30, CY_CONTROL_FILE=<:default:>, CY_DATASHEET_FILE=<:default:>, CY_FITTER_NAME=PWM_MOTOR_RIGHT, CY_INSTANCE_SHORT_NAME=PWM_MOTOR_RIGHT, CY_MAJOR_VERSION=3, CY_MINOR_VERSION=30, CY_REMOVE=false, CY_SUPPRESS_API_GEN=false, CY_VERSION=PSoC Creator  3.3, INSTANCE_NAME=PWM_MOTOR_RIGHT, )
module PWM_v3_30_1 (
    pwm2,
    tc,
    clock,
...
// PWM_v3_30(CaptureMode=0, Clock_CheckTolerance=true, Clock_desired_freq=12, Clock_desired_freq_unit=6, Clock_divisor=1, Clock_FractDividerDenominator=0, Clock_FractDividerNumerator=0, Clock_FractDividerUsed=false, Clock_is_direct=false, Clock_is_divider=false, Clock_is_freq=true, Clock_minus_tolerance=5, Clock_ph_align_clock_id=, Clock_ph_align_clock_name=, Clock_plus_tolerance=5, Clock_source_clock_id=, Clock_source_clock_name=, Compare1_16=false, Compare1_8=false, Compare2_16=true, Compare2_8=false, CompareStatusEdgeSense=true, CompareType1=1, CompareType1Software=0, CompareType2=1, CompareType2Software=0, CompareValue1=900, CompareValue2=900, CONTROL3=0, ControlReg=true, CtlModeReplacementString=SyncCtl, CyGetRegReplacementString=CY_GET_REG16, CySetRegReplacementString=CY_SET_REG16, DeadBand=0, DeadBand2_4=0, DeadBand256=0, DeadBandUsed=0, DeadTime=1, DitherOffset=0, EnableMode=0, FF16=false, FF8=false, FixedFunction=false, FixedFunctionUsed=0, InterruptOnCMP1=false, InterruptOnCMP2=false, InterruptOnKill=false, InterruptOnTC=false, IntOnCMP1=0, IntOnCMP2=0, IntOnKill=0, IntOnTC=0, KillMode=0, KillModeMinTime=0, MinimumKillTime=1, OneCompare=false, Period=1000, PWMMode=1, PWMModeCenterAligned=0, RegDefReplacementString=reg16, RegSizeReplacementString=uint16, Resolution=16, RstStatusReplacementString=sSTSReg_rstSts, RunMode=0, Status=false, TermMode_capture=0, TermMode_clock=0, TermMode_cmp_sel=0, TermMode_enable=0, TermMode_interrupt=0, TermMode_kill=0, TermMode_ph1=0, TermMode_ph2=0, TermMode_pwm=0, TermMode_pwm1=0, TermMode_pwm2=0, TermMode_reset=0, TermMode_tc=0, TermMode_trigger=0, TermVisibility_capture=false, TermVisibility_clock=true, TermVisibility_cmp_sel=false, TermVisibility_enable=false, TermVisibility_interrupt=false, TermVisibility_kill=false, TermVisibility_ph1=false, TermVisibility_ph2=false, TermVisibility_pwm=false, TermVisibility_pwm1=true, TermVisibility_pwm2=true, TermVisibility_reset=true, TermVisibility_tc=true, TermVisibility_trigger=false, TriggerMode=0, UDB16=true, UDB8=false, UseControl=true, UseInterrupt=false, UseStatus=false, VerilogSectionReplacementString=sP16, CY_API_CALLBACK_HEADER_INCLUDE=#include "cyapicallbacks.h", CY_COMPONENT_NAME=PWM_v3_30, CY_CONTROL_FILE=<:default:>, CY_DATASHEET_FILE=<:default:>, CY_FITTER_NAME=PWM_MOTOR_LEFT, CY_INSTANCE_SHORT_NAME=PWM_MOTOR_LEFT, CY_MAJOR_VERSION=3, CY_MINOR_VERSION=30, CY_REMOVE=false, CY_SUPPRESS_API_GEN=false, CY_VERSION=PSoC Creator  3.3, INSTANCE_NAME=PWM_MOTOR_LEFT, )
module PWM_v3_30_2 (
    pwm2,
    tc,
    clock,
...
`ifdef WARP
`define CY_BLK_DIR "D:\Program Files (x86)\Cypress\PSoC Creator\3.3\PSoC Creator\psoc\content\cycomponentlibrary\CyComponentLibrary.cylib\ADC_AMUX_v2_0"
`include "D:\Program Files (x86)\Cypress\PSoC Creator\3.3\PSoC Creator\psoc\content\cycomponentlibrary\CyComponentLibrary.cylib\ADC_AMUX_v2_0\ADC_AMUX_v2_0.v"
`else
`define CY_BLK_DIR "D:\Program Files (x86)\Cypress\PSoC Creator\3.3\PSoC Creator\psoc\content\cycomponentlibrary\CyComponentLibrary.cylib\ADC_AMUX_v2_0"
`include "D:\Program Files (x86)\Cypress\PSoC Creator\3.3\PSoC Creator\psoc\content\cycomponentlibrary\CyComponentLibrary.cylib\ADC_AMUX_v2_0\ADC_AMUX_v2_0.v"
`endif
...
`ifdef WARP
`define CY_BLK_DIR "D:\Program Files (x86)\Cypress\PSoC Creator\3.3\PSoC Creator\psoc\content\cycomponentlibrary\CyComponentLibrary.cylib\bADC_SAR_SEQ_v2_0"
`include "D:\Program Files (x86)\Cypress\PSoC Creator\3.3\PSoC Creator\psoc\content\cycomponentlibrary\CyComponentLibrary.cylib\bADC_SAR_SEQ_v2_0\bADC_SAR_SEQ_v2_0.v"
`else
`define CY_BLK_DIR "D:\Program Files (x86)\Cypress\PSoC Creator\3.3\PSoC Creator\psoc\content\cycomponentlibrary\CyComponentLibrary.cylib\bADC_SAR_SEQ_v2_0"
`include "D:\Program Files (x86)\Cypress\PSoC Creator\3.3\PSoC Creator\psoc\content\cycomponentlibrary\CyComponentLibrary.cylib\bADC_SAR_SEQ_v2_0\bADC_SAR_SEQ_v2_0.v"
`endif
...
`ifdef WARP
`define CY_BLK_DIR "D:\Program Files (x86)\Cypress\PSoC Creator\3.3\PSoC Creator\psoc\content\cycomponentlibrary\CyComponentLibrary.cylib\bQuadDec_v3_0"
`include "D:\Program Files (x86)\Cypress\PSoC Creator\3.3\PSoC Creator\psoc\content\cycomponentlibrary\CyComponentLibrary.cylib\bQuadDec_v3_0\bQuadDec_v3_0.v"
`else
`define CY_BLK_DIR "D:\Program Files (x86)\Cypress\PSoC Creator\3.3\PSoC Creator\psoc\content\cycomponentlibrary\CyComponentLibrary.cylib\bQuadDec_v3_0"
`include "D:\Program Files (x86)\Cypress\PSoC Creator\3.3\PSoC Creator\psoc\content\cycomponentlibrary\CyComponentLibrary.cylib\bQuadDec_v3_0\bQuadDec_v3_0.v"
`endif
...
`ifdef WARP
`define CY_BLK_DIR "D:\Program Files (x86)\Cypress\PSoC Creator\3.3\PSoC Creator\psoc\content\cyprimitives\CyPrimitives.cylib\and_v1_0"
`include "D:\Program Files (x86)\Cypress\PSoC Creator\3.3\PSoC Creator\psoc\content\cyprimitives\CyPrimitives.cylib\and_v1_0\and_v1_0.v"
`else
`define CY_BLK_DIR "D:\Program Files (x86)\Cypress\PSoC Creator\3.3\PSoC Creator\psoc\content\cyprimitives\CyPrimitives.cylib\and_v1_0"
`include "D:\Program Files (x86)\Cypress\PSoC Creator\3.3\PSoC Creator\psoc\content\cyprimitives\CyPrimitives.cylib\and_v1_0\and_v1_0.v"
`endif

// QuadDec_v3_0(Counter8bit=false, CounterResolution=1, CounterSize=32, CounterSizeReplacementString=int32, CounterSizeReplacementStringUnsigned=uint16, TypeCastReplacementString=int32, UsingGlitchFiltering=true, UsingIndexInput=false, CY_API_CALLBACK_HEADER_INCLUDE=#include "cyapicallbacks.h", CY_COMPONENT_NAME=QuadDec_v3_0, CY_CONTROL_FILE=<:default:>, CY_DATASHEET_FILE=<:default:>, CY_FITTER_NAME=ECDR, CY_INSTANCE_SHORT_NAME=ECDR, CY_MAJOR_VERSION=3, CY_MINOR_VERSION=0, CY_REMOVE=false, CY_SUPPRESS_API_GEN=false, CY_VERSION=PSoC Creator  3.3, INSTANCE_NAME=ECDR, )
...
// PWM_v3_30(CaptureMode=0, Clock_CheckTolerance=true, Clock_desired_freq=12, Clock_desired_freq_unit=6, Clock_divisor=1, Clock_FractDividerDenominator=0, Clock_FractDividerNumerator=0, Clock_FractDividerUsed=false, Clock_is_direct=false, Clock_is_divider=false, Clock_is_freq=true, Clock_minus_tolerance=5, Clock_ph_align_clock_id=, Clock_ph_align_clock_name=, Clock_plus_tolerance=5, Clock_source_clock_id=, Clock_source_clock_name=, Compare1_16=false, Compare1_8=false, Compare2_16=false, Compare2_8=false, CompareStatusEdgeSense=true, CompareType1=1, CompareType1Software=0, CompareType2=1, CompareType2Software=0, CompareValue1=5000, CompareValue2=63, CONTROL3=1, ControlReg=false, CtlModeReplacementString=SyncCtl, CyGetRegReplacementString=CY_GET_REG16, CySetRegReplacementString=CY_SET_REG16, DeadBand=0, DeadBand2_4=0, DeadBand256=0, DeadBandUsed=0, DeadTime=3, DitherOffset=0, EnableMode=0, FF16=true, FF8=false, FixedFunction=true, FixedFunctionUsed=1, InterruptOnCMP1=false, InterruptOnCMP2=false, InterruptOnKill=false, InterruptOnTC=false, IntOnCMP1=0, IntOnCMP2=0, IntOnKill=0, IntOnTC=0, KillMode=1, KillModeMinTime=0, MinimumKillTime=1, OneCompare=true, Period=10000, PWMMode=0, PWMModeCenterAligned=0, RegDefReplacementString=reg16, RegSizeReplacementString=uint16, Resolution=16, RstStatusReplacementString=sSTSReg_rstSts, RunMode=0, Status=false, TermMode_capture=0, TermMode_clock=0, TermMode_cmp_sel=0, TermMode_enable=0, TermMode_interrupt=0, TermMode_kill=0, TermMode_ph1=0, TermMode_ph2=0, TermMode_pwm=0, TermMode_pwm1=0, TermMode_pwm2=0, TermMode_reset=0, TermMode_tc=0, TermMode_trigger=0, TermVisibility_capture=false, TermVisibility_clock=true, TermVisibility_cmp_sel=false, TermVisibility_enable=false, TermVisibility_interrupt=false, TermVisibility_kill=true, TermVisibility_ph1=false, TermVisibility_ph2=false, TermVisibility_pwm=true, TermVisibility_pwm1=false, TermVisibility_pwm2=false, TermVisibility_reset=true, TermVisibility_tc=true, TermVisibility_trigger=false, TriggerMode=0, UDB16=false, UDB8=false, UseControl=true, UseInterrupt=false, UseStatus=false, VerilogSectionReplacementString=sP16, CY_API_CALLBACK_HEADER_INCLUDE=#include "cyapicallbacks.h", CY_COMPONENT_NAME=PWM_v3_30, CY_CONTROL_FILE=<:default:>, CY_DATASHEET_FILE=<:default:>, CY_FITTER_NAME=PWM_LED_1, CY_INSTANCE_SHORT_NAME=PWM_LED_1, CY_MAJOR_VERSION=3, CY_MINOR_VERSION=30, CY_REMOVE=false, CY_SUPPRESS_API_GEN=false, CY_VERSION=PSoC Creator  3.3, INSTANCE_NAME=PWM_LED_1, )
module PWM_v3_30_9 (
    pwm2,
    tc,
    clock,
...
// PWM_v3_30(CaptureMode=0, Clock_CheckTolerance=true, Clock_desired_freq=12, Clock_desired_freq_unit=6, Clock_divisor=1, Clock_FractDividerDenominator=0, Clock_FractDividerNumerator=0, Clock_FractDividerUsed=false, Clock_is_direct=false, Clock_is_divider=false, Clock_is_freq=true, Clock_minus_tolerance=5, Clock_ph_align_clock_id=, Clock_ph_align_clock_name=, Clock_plus_tolerance=5, Clock_source_clock_id=, Clock_source_clock_name=, Compare1_16=false, Compare1_8=false, Compare2_16=false, Compare2_8=false, CompareStatusEdgeSense=true, CompareType1=1, CompareType1Software=0, CompareType2=1, CompareType2Software=0, CompareValue1=5000, CompareValue2=63, CONTROL3=1, ControlReg=false, CtlModeReplacementString=SyncCtl, CyGetRegReplacementString=CY_GET_REG16, CySetRegReplacementString=CY_SET_REG16, DeadBand=0, DeadBand2_4=0, DeadBand256=0, DeadBandUsed=0, DeadTime=3, DitherOffset=0, EnableMode=0, FF16=true, FF8=false, FixedFunction=true, FixedFunctionUsed=1, InterruptOnCMP1=false, InterruptOnCMP2=false, InterruptOnKill=false, InterruptOnTC=false, IntOnCMP1=0, IntOnCMP2=0, IntOnKill=0, IntOnTC=0, KillMode=1, KillModeMinTime=0, MinimumKillTime=1, OneCompare=true, Period=10000, PWMMode=0, PWMModeCenterAligned=0, RegDefReplacementString=reg16, RegSizeReplacementString=uint16, Resolution=16, RstStatusReplacementString=sSTSReg_rstSts, RunMode=0, Status=false, TermMode_capture=0, TermMode_clock=0, TermMode_cmp_sel=0, TermMode_enable=0, TermMode_interrupt=0, TermMode_kill=0, TermMode_ph1=0, TermMode_ph2=0, TermMode_pwm=0, TermMode_pwm1=0, TermMode_pwm2=0, TermMode_reset=0, TermMode_tc=0, TermMode_trigger=0, TermVisibility_capture=false, TermVisibility_clock=true, TermVisibility_cmp_sel=false, TermVisibility_enable=false, TermVisibility_interrupt=false, TermVisibility_kill=true, TermVisibility_ph1=false, TermVisibility_ph2=false, TermVisibility_pwm=true, TermVisibility_pwm1=false, TermVisibility_pwm2=false, TermVisibility_reset=true, TermVisibility_tc=true, TermVisibility_trigger=false, TriggerMode=0, UDB16=false, UDB8=false, UseControl=true, UseInterrupt=false, UseStatus=false, VerilogSectionReplacementString=sP16, CY_API_CALLBACK_HEADER_INCLUDE=#include "cyapicallbacks.h", CY_COMPONENT_NAME=PWM_v3_30, CY_CONTROL_FILE=<:default:>, CY_DATASHEET_FILE=<:default:>, CY_FITTER_NAME=PWM_LED_3, CY_INSTANCE_SHORT_NAME=PWM_LED_3, CY_MAJOR_VERSION=3, CY_MINOR_VERSION=30, CY_REMOVE=false, CY_SUPPRESS_API_GEN=false, CY_VERSION=PSoC Creator  3.3, INSTANCE_NAME=PWM_LED_3, )
module PWM_v3_30_10 (
    pwm2,
    tc,
    clock,
...
// PWM_v3_30(CaptureMode=0, Clock_CheckTolerance=true, Clock_desired_freq=12, Clock_desired_freq_unit=6, Clock_divisor=1, Clock_FractDividerDenominator=0, Clock_FractDividerNumerator=0, Clock_FractDividerUsed=false, Clock_is_direct=false, Clock_is_divider=false, Clock_is_freq=true, Clock_minus_tolerance=5, Clock_ph_align_clock_id=, Clock_ph_align_clock_name=, Clock_plus_tolerance=5, Clock_source_clock_id=, Clock_source_clock_name=, Compare1_16=false, Compare1_8=false, Compare2_16=false, Compare2_8=false, CompareStatusEdgeSense=true, CompareType1=1, CompareType1Software=0, CompareType2=1, CompareType2Software=0, CompareValue1=5000, CompareValue2=63, CONTROL3=1, ControlReg=false, CtlModeReplacementString=SyncCtl, CyGetRegReplacementString=CY_GET_REG16, CySetRegReplacementString=CY_SET_REG16, DeadBand=0, DeadBand2_4=0, DeadBand256=0, DeadBandUsed=0, DeadTime=3, DitherOffset=0, EnableMode=0, FF16=true, FF8=false, FixedFunction=true, FixedFunctionUsed=1, InterruptOnCMP1=false, InterruptOnCMP2=false, InterruptOnKill=false, InterruptOnTC=false, IntOnCMP1=0, IntOnCMP2=0, IntOnKill=0, IntOnTC=0, KillMode=1, KillModeMinTime=0, MinimumKillTime=1, OneCompare=true, Period=10000, PWMMode=0, PWMModeCenterAligned=0, RegDefReplacementString=reg16, RegSizeReplacementString=uint16, Resolution=16, RstStatusReplacementString=sSTSReg_rstSts, RunMode=0, Status=false, TermMode_capture=0, TermMode_clock=0, TermMode_cmp_sel=0, TermMode_enable=0, TermMode_interrupt=0, TermMode_kill=0, TermMode_ph1=0, TermMode_ph2=0, TermMode_pwm=0, TermMode_pwm1=0, TermMode_pwm2=0, TermMode_reset=0, TermMode_tc=0, TermMode_trigger=0, TermVisibility_capture=false, TermVisibility_clock=true, TermVisibility_cmp_sel=false, TermVisibility_enable=false, TermVisibility_interrupt=false, TermVisibility_kill=true, TermVisibility_ph1=false, TermVisibility_ph2=false, TermVisibility_pwm=true, TermVisibility_pwm1=false, TermVisibility_pwm2=false, TermVisibility_reset=true, TermVisibility_tc=true, TermVisibility_trigger=false, TriggerMode=0, UDB16=false, UDB8=false, UseControl=true, UseInterrupt=false, UseStatus=false, VerilogSectionReplacementString=sP16, CY_API_CALLBACK_HEADER_INCLUDE=#include "cyapicallbacks.h", CY_COMPONENT_NAME=PWM_v3_30, CY_CONTROL_FILE=<:default:>, CY_DATASHEET_FILE=<:default:>, CY_FITTER_NAME=PWM_LED_2, CY_INSTANCE_SHORT_NAME=PWM_LED_2, CY_MAJOR_VERSION=3, CY_MINOR_VERSION=30, CY_REMOVE=false, CY_SUPPRESS_API_GEN=false, CY_VERSION=PSoC Creator  3.3, INSTANCE_NAME=PWM_LED_2, )
module PWM_v3_30_11 (
    pwm2,
    tc,
    clock,
...
// PWM_v3_30(CaptureMode=0, Clock_CheckTolerance=true, Clock_desired_freq=12, Clock_desired_freq_unit=6, Clock_divisor=1, Clock_FractDividerDenominator=0, Clock_FractDividerNumerator=0, Clock_FractDividerUsed=false, Clock_is_direct=false, Clock_is_divider=false, Clock_is_freq=true, Clock_minus_tolerance=5, Clock_ph_align_clock_id=, Clock_ph_align_clock_name=, Clock_plus_tolerance=5, Clock_source_clock_id=, Clock_source_clock_name=, Compare1_16=false, Compare1_8=false, Compare2_16=false, Compare2_8=false, CompareStatusEdgeSense=true, CompareType1=1, CompareType1Software=0, CompareType2=1, CompareType2Software=0, CompareValue1=5000, CompareValue2=63, CONTROL3=1, ControlReg=false, CtlModeReplacementString=SyncCtl, CyGetRegReplacementString=CY_GET_REG16, CySetRegReplacementString=CY_SET_REG16, DeadBand=0, DeadBand2_4=0, DeadBand256=0, DeadBandUsed=0, DeadTime=3, DitherOffset=0, EnableMode=0, FF16=true, FF8=false, FixedFunction=true, FixedFunctionUsed=1, InterruptOnCMP1=false, InterruptOnCMP2=false, InterruptOnKill=false, InterruptOnTC=false, IntOnCMP1=0, IntOnCMP2=0, IntOnKill=0, IntOnTC=0, KillMode=1, KillModeMinTime=0, MinimumKillTime=1, OneCompare=true, Period=10000, PWMMode=0, PWMModeCenterAligned=0, RegDefReplacementString=reg16, RegSizeReplacementString=uint16, Resolution=16, RstStatusReplacementString=sSTSReg_rstSts, RunMode=0, Status=false, TermMode_capture=0, TermMode_clock=0, TermMode_cmp_sel=0, TermMode_enable=0, TermMode_interrupt=0, TermMode_kill=0, TermMode_ph1=0, TermMode_ph2=0, TermMode_pwm=0, TermMode_pwm1=0, TermMode_pwm2=0, TermMode_reset=0, TermMode_tc=0, TermMode_trigger=0, TermVisibility_capture=false, TermVisibility_clock=true, TermVisibility_cmp_sel=false, TermVisibility_enable=false, TermVisibility_interrupt=false, TermVisibility_kill=true, TermVisibility_ph1=false, TermVisibility_ph2=false, TermVisibility_pwm=true, TermVisibility_pwm1=false, TermVisibility_pwm2=false, TermVisibility_reset=true, TermVisibility_tc=true, TermVisibility_trigger=false, TriggerMode=0, UDB16=false, UDB8=false, UseControl=true, UseInterrupt=false, UseStatus=false, VerilogSectionReplacementString=sP16, CY_API_CALLBACK_HEADER_INCLUDE=#include "cyapicallbacks.h", CY_COMPONENT_NAME=PWM_v3_30, CY_CONTROL_FILE=<:default:>, CY_DATASHEET_FILE=<:default:>, CY_FITTER_NAME=PWM_LED_4, CY_INSTANCE_SHORT_NAME=PWM_LED_4, CY_MAJOR_VERSION=3, CY_MINOR_VERSION=30, CY_REMOVE=false, CY_SUPPRESS_API_GEN=false, CY_VERSION=PSoC Creator  3.3, INSTANCE_NAME=PWM_LED_4, )
module PWM_v3_30_12 (
    pwm2,
    tc,
    clock,
...
// UART_v2_50(Address1=0, Address2=0, BaudRate=2400, BreakBitsRX=13, BreakBitsTX=13, BreakDetect=false, CRCoutputsEn=false, Enable_RX=1, Enable_RXIntInterrupt=0, Enable_TX=1, Enable_TXIntInterrupt=0, EnableHWAddress=0, EnIntRXInterrupt=false, EnIntTXInterrupt=false, FlowControl=0, HalfDuplexEn=false, HwTXEnSignal=true, InternalClock=true, InternalClockToleranceMinus=3.93736842105263, InternalClockTolerancePlus=3.93736842105263, InternalClockUsed=1, InterruptOnAddDetect=0, InterruptOnAddressMatch=0, InterruptOnBreak=0, InterruptOnByteRcvd=1, InterruptOnOverrunError=0, InterruptOnParityError=0, InterruptOnStopError=0, InterruptOnTXComplete=false, InterruptOnTXFifoEmpty=false, InterruptOnTXFifoFull=false, InterruptOnTXFifoNotFull=false, IntOnAddressDetect=false, IntOnAddressMatch=false, IntOnBreak=false, IntOnByteRcvd=true, IntOnOverrunError=false, IntOnParityError=false, IntOnStopError=false, NumDataBits=8, NumStopBits=1, OverSamplingRate=8, ParityType=0, ParityTypeSw=false, RequiredClock=19200, RXAddressMode=0, RXBufferSize=4, RxBuffRegSizeReplacementString=uint8, RXEnable=true, TXBitClkGenDP=true, TXBufferSize=4, TxBuffRegSizeReplacementString=uint8, TXEnable=true, Use23Polling=true, CY_API_CALLBACK_HEADER_INCLUDE=#include "cyapicallbacks.h", CY_COMPONENT_NAME=UART_v2_50, CY_CONTROL_FILE=<:default:>, CY_DATASHEET_FILE=<:default:>, CY_FITTER_NAME=UART_CH, CY_INSTANCE_SHORT_NAME=UART_CH, CY_MAJOR_VERSION=2, CY_MINOR_VERSION=50, CY_REMOVE=false, CY_SUPPRESS_API_GEN=false, CY_VERSION=PSoC Creator  3.3, INSTANCE_NAME=UART_CH, )
module UART_v2_50_13 (
	...
	cy_clock_v1_0
		#(.id("46135cb0-d461-4998-b6e3-9e4c1cad5306/be0a0e37-ad17-42ca-b5a1-1a654d736358"),
		  .source_clock_id(""),
		  .divisor(0),
		  .period("52083333333.3333"),
		  .is_direct(0),
		  .is_digital(1))
		IntClock
		 (.clock_out(Net_9));
...
module top ;
    ...
    PWM_v3_30_1 PWM_MOTOR_RIGHT (
        ...
        .ph1(Net_16148),
        .ph2(Net_16149));
    defparam PWM_MOTOR_RIGHT.Resolution = 16;

    PWM_v3_30_2 PWM_MOTOR_LEFT (
        .reset(Net_490),
        .clock(Net_15638),
        .tc(Net_491),
        .pwm1(Net_15717),
        ...
        .ph1(Net_500),
        .ph2(Net_501));
    defparam PWM_MOTOR_LEFT.Resolution = 16;
	...
	wire [0:0] tmpOE__EM1_net;
	wire [0:0] tmpFB_0__EM1_net;
	wire [0:0] tmpIO_0__EM1_net;
	wire [0:0] tmpINTERRUPT_0__EM1_net;
	electrical [0:0] tmpSIOVREF__EM1_net;
	...
	cy_psoc3_pins_v1_10
		...
		EM1
		 (.oe(tmpOE__EM1_net),
		  .y({1'b0}),
		  .fb({tmpFB_0__EM1_net[0:0]}),
		  .io({tmpIO_0__EM1_net[0:0]}),
		  .siovref(tmpSIOVREF__EM1_net),
		  .interrupt({tmpINTERRUPT_0__EM1_net[0:0]}),
		  .in_clock({1'b0}),
		  .in_clock_en({1'b1}),
		  .in_reset({1'b0}),
		  .out_clock({1'b0}),
	...
	assign tmpOE__EM1_net = (`CYDEV_CHIP_MEMBER_USED == `CYDEV_CHIP_MEMBER_3A && `CYDEV_CHIP_REVISION_USED < `CYDEV_CHIP_REVISION_3A_ES3) ? ~{1'b1} : {1'b1};

	wire [0:0] tmpOE__EM2_net;
	wire [0:0] tmpFB_0__EM2_net;
	wire [0:0] tmpIO_0__EM2_net;
	wire [0:0] tmpINTERRUPT_0__EM2_net;
	electrical [0:0] tmpSIOVREF__EM2_net;
	...
	cy_psoc3_pins_v1_10
		...
		EM2
		 (.oe(tmpOE__EM2_net),
		  .y({1'b0}),
		  .fb({tmpFB_0__EM2_net[0:0]}),
		  .io({tmpIO_0__EM2_net[0:0]}),
		  .siovref(tmpSIOVREF__EM2_net),
		  .interrupt({tmpINTERRUPT_0__EM2_net[0:0]}),
		  .in_clock({1'b0}),
		  .in_clock_en({1'b1}),
		  .in_reset({1'b0}),
		  .out_clock({1'b0}),
	...
	assign tmpOE__EM2_net = (`CYDEV_CHIP_MEMBER_USED == `CYDEV_CHIP_MEMBER_3A && `CYDEV_CHIP_REVISION_USED < `CYDEV_CHIP_REVISION_3A_ES3) ? ~{1'b1} : {1'b1};
	...
	cy_psoc3_pins_v1_10
		#(.id("511e705c-d284-4250-9144-a3a1a8e8943c"),
		  .drive_mode(3'b100),
		  .ibuf_enabled(1'b1),
		  .init_dr_st(1'b1),
		  .input_clk_en(0),
	...
	cy_psoc3_pins_v1_10
		#(.id("85623144-97e4-4f40-a4bb-97c799cf10a5"),
		  .drive_mode(3'b110),
		  .ibuf_enabled(1'b1),
		  .init_dr_st(1'b1),
		  .input_clk_en(0),
	...
	wire [0:0] tmpOE__PTZ_UP_EN_net;
	wire [0:0] tmpFB_0__PTZ_UP_EN_net;
	wire [0:0] tmpIO_0__PTZ_UP_EN_net;
	wire [0:0] tmpINTERRUPT_0__PTZ_UP_EN_net;
	electrical [0:0] tmpSIOVREF__PTZ_UP_EN_net;

	cy_psoc3_pins_v1_10
		#(.id("4eee43cc-7bb5-44ed-b12d-ee1d220b71c2"),
		  .drive_mode(3'b110),
		  .ibuf_enabled(1'b1),
		  .init_dr_st(1'b1),
		  .input_clk_en(0),
		  ...
		  .input_buffer_sel(2'b00))
		PTZ_UP_EN
		 (.oe(tmpOE__PTZ_UP_EN_net),
		  .y({1'b0}),
		  .fb({tmpFB_0__PTZ_UP_EN_net[0:0]}),
		  .io({tmpIO_0__PTZ_UP_EN_net[0:0]}),
		  .siovref(tmpSIOVREF__PTZ_UP_EN_net),
		  .interrupt({tmpINTERRUPT_0__PTZ_UP_EN_net[0:0]}),
		  .in_clock({1'b0}),
		  .in_clock_en({1'b1}),
		  .in_reset({1'b0}),
		  .out_clock({1'b0}),
	...
	assign tmpOE__PTZ_UP_EN_net = (`CYDEV_CHIP_MEMBER_USED == `CYDEV_CHIP_MEMBER_3A && `CYDEV_CHIP_REVISION_USED < `CYDEV_CHIP_REVISION_3A_ES3) ? ~{1'b1} : {1'b1};

	wire [0:0] tmpOE__PTZ_UP_STEP_net;
	wire [0:0] tmpFB_0__PTZ_UP_STEP_net;
	wire [0:0] tmpIO_0__PTZ_UP_STEP_net;
	wire [0:0] tmpINTERRUPT_0__PTZ_UP_STEP_net;
	electrical [0:0] tmpSIOVREF__PTZ_UP_STEP_net;

	cy_psoc3_pins_v1_10
		#(.id("704ed270-d8a7-40ac-afe2-c1acc208dc1f"),
		  .drive_mode(3'b110),
		  .ibuf_enabled(1'b1),
		  .init_dr_st(1'b1),
		  .input_clk_en(0),
		  ...
		  .input_buffer_sel(2'b00))
		PTZ_UP_STEP
		 (.oe(tmpOE__PTZ_UP_STEP_net),
		  .y({1'b0}),
		  .fb({tmpFB_0__PTZ_UP_STEP_net[0:0]}),
		  .io({tmpIO_0__PTZ_UP_STEP_net[0:0]}),
		  .siovref(tmpSIOVREF__PTZ_UP_STEP_net),
		  .interrupt({tmpINTERRUPT_0__PTZ_UP_STEP_net[0:0]}),
		  .in_clock({1'b0}),
		  .in_clock_en({1'b1}),
		  .in_reset({1'b0}),
		  .out_clock({1'b0}),
	...
	assign tmpOE__PTZ_UP_STEP_net = (`CYDEV_CHIP_MEMBER_USED == `CYDEV_CHIP_MEMBER_3A && `CYDEV_CHIP_REVISION_USED < `CYDEV_CHIP_REVISION_3A_ES3) ? ~{1'b1} : {1'b1};

	wire [0:0] tmpOE__PTZ_UP_DIR_net;
	wire [0:0] tmpFB_0__PTZ_UP_DIR_net;
	wire [0:0] tmpIO_0__PTZ_UP_DIR_net;
	wire [0:0] tmpINTERRUPT_0__PTZ_UP_DIR_net;
	electrical [0:0] tmpSIOVREF__PTZ_UP_DIR_net;

	cy_psoc3_pins_v1_10
		#(.id("6f811a71-499c-411d-8584-58a3ee178395"),
		  .drive_mode(3'b110),
		  .ibuf_enabled(1'b1),
		  .init_dr_st(1'b1),
		  .input_clk_en(0),
		  ...
		  .input_buffer_sel(2'b00))
		PTZ_UP_DIR
		 (.oe(tmpOE__PTZ_UP_DIR_net),
		  .y({1'b0}),
		  .fb({tmpFB_0__PTZ_UP_DIR_net[0:0]}),
		  .io({tmpIO_0__PTZ_UP_DIR_net[0:0]}),
		  .siovref(tmpSIOVREF__PTZ_UP_DIR_net),
		  .interrupt({tmpINTERRUPT_0__PTZ_UP_DIR_net[0:0]}),
		  .in_clock({1'b0}),
		  .in_clock_en({1'b1}),
		  .in_reset({1'b0}),
		  .out_clock({1'b0}),
	...
	assign tmpOE__PTZ_UP_DIR_net = (`CYDEV_CHIP_MEMBER_USED == `CYDEV_CHIP_MEMBER_3A && `CYDEV_CHIP_REVISION_USED < `CYDEV_CHIP_REVISION_3A_ES3) ? ~{1'b1} : {1'b1};

	wire [0:0] tmpOE__PTZ_DOWN_EN_net;
	wire [0:0] tmpFB_0__PTZ_DOWN_EN_net;
	wire [0:0] tmpIO_0__PTZ_DOWN_EN_net;
	wire [0:0] tmpINTERRUPT_0__PTZ_DOWN_EN_net;
	electrical [0:0] tmpSIOVREF__PTZ_DOWN_EN_net;

	cy_psoc3_pins_v1_10
		#(.id("515c4cb1-e5c0-408e-a294-17c639ec64ff"),
		  .drive_mode(3'b110),
		  .ibuf_enabled(1'b1),
		  .init_dr_st(1'b1),
		  .input_clk_en(0),
		  ...
		  .input_buffer_sel(2'b00))
		PTZ_DOWN_EN
		 (.oe(tmpOE__PTZ_DOWN_EN_net),
		  .y({1'b0}),
		  .fb({tmpFB_0__PTZ_DOWN_EN_net[0:0]}),
		  .io({tmpIO_0__PTZ_DOWN_EN_net[0:0]}),
		  .siovref(tmpSIOVREF__PTZ_DOWN_EN_net),
		  .interrupt({tmpINTERRUPT_0__PTZ_DOWN_EN_net[0:0]}),
		  .in_clock({1'b0}),
		  .in_clock_en({1'b1}),
		  .in_reset({1'b0}),
		  .out_clock({1'b0}),
	...
	assign tmpOE__PTZ_DOWN_EN_net = (`CYDEV_CHIP_MEMBER_USED == `CYDEV_CHIP_MEMBER_3A && `CYDEV_CHIP_REVISION_USED < `CYDEV_CHIP_REVISION_3A_ES3) ? ~{1'b1} : {1'b1};

	wire [0:0] tmpOE__PTZ_DOWN_STEP_net;
	wire [0:0] tmpFB_0__PTZ_DOWN_STEP_net;
	wire [0:0] tmpIO_0__PTZ_DOWN_STEP_net;
	wire [0:0] tmpINTERRUPT_0__PTZ_DOWN_STEP_net;
	electrical [0:0] tmpSIOVREF__PTZ_DOWN_STEP_net;

	cy_psoc3_pins_v1_10
		#(.id("19713223-88e7-4209-a07e-9abab1a57b5a"),
		  .drive_mode(3'b110),
		  .ibuf_enabled(1'b1),
		  .init_dr_st(1'b1),
		  .input_clk_en(0),
		  ...
		  .input_buffer_sel(2'b00))
		PTZ_DOWN_STEP
		 (.oe(tmpOE__PTZ_DOWN_STEP_net),
		  .y({1'b0}),
		  .fb({tmpFB_0__PTZ_DOWN_STEP_net[0:0]}),
		  .io({tmpIO_0__PTZ_DOWN_STEP_net[0:0]}),
		  .siovref(tmpSIOVREF__PTZ_DOWN_STEP_net),
		  .interrupt({tmpINTERRUPT_0__PTZ_DOWN_STEP_net[0:0]}),
		  .in_clock({1'b0}),
		  .in_clock_en({1'b1}),
		  .in_reset({1'b0}),
		  .out_clock({1'b0}),
	...
	assign tmpOE__PTZ_DOWN_STEP_net = (`CYDEV_CHIP_MEMBER_USED == `CYDEV_CHIP_MEMBER_3A && `CYDEV_CHIP_REVISION_USED < `CYDEV_CHIP_REVISION_3A_ES3) ? ~{1'b1} : {1'b1};

	wire [0:0] tmpOE__PTZ_DOWN_DIR_net;
	wire [0:0] tmpFB_0__PTZ_DOWN_DIR_net;
	wire [0:0] tmpIO_0__PTZ_DOWN_DIR_net;
	wire [0:0] tmpINTERRUPT_0__PTZ_DOWN_DIR_net;
	electrical [0:0] tmpSIOVREF__PTZ_DOWN_DIR_net;

	cy_psoc3_pins_v1_10
		#(.id("99e3ec70-7199-4c17-a3bb-35aff8d2dc3b"),
		  .drive_mode(3'b110),
		  .ibuf_enabled(1'b1),
		  .init_dr_st(1'b1),
		  .input_clk_en(0),
		  ...
		  .input_buffer_sel(2'b00))
		PTZ_DOWN_DIR
		 (.oe(tmpOE__PTZ_DOWN_DIR_net),
		  .y({1'b0}),
		  .fb({tmpFB_0__PTZ_DOWN_DIR_net[0:0]}),
		  .io({tmpIO_0__PTZ_DOWN_DIR_net[0:0]}),
		  .siovref(tmpSIOVREF__PTZ_DOWN_DIR_net),
		  .interrupt({tmpINTERRUPT_0__PTZ_DOWN_DIR_net[0:0]}),
		  .in_clock({1'b0}),
		  .in_clock_en({1'b1}),
		  .in_reset({1'b0}),
		  .out_clock({1'b0}),
	...
	assign tmpOE__PTZ_DOWN_DIR_net = (`CYDEV_CHIP_MEMBER_USED == `CYDEV_CHIP_MEMBER_3A && `CYDEV_CHIP_REVISION_USED < `CYDEV_CHIP_REVISION_3A_ES3) ? ~{1'b1} : {1'b1};
	...
	cy_psoc3_pins_v1_10
		#(.id("0eed30e6-9bdf-427e-b4e5-e051677e79ef"),
		  .drive_mode(3'b000),
		  .ibuf_enabled(1'b0),
		  .init_dr_st(1'b0),
		  .input_clk_en(0),
	...
	wire [0:0] tmpOE__CHANGE_PWR_net;
	wire [0:0] tmpFB_0__CHANGE_PWR_net;
	wire [0:0] tmpIO_0__CHANGE_PWR_net;
	wire [0:0] tmpINTERRUPT_0__CHANGE_PWR_net;
	electrical [0:0] tmpSIOVREF__CHANGE_PWR_net;

	cy_psoc3_pins_v1_10
		#(.id("97db5f83-7c41-44ad-8065-de08ba273f8b"),
		  .drive_mode(3'b110),
		  .ibuf_enabled(1'b1),
		  .init_dr_st(1'b0),
		  .input_clk_en(0),
		  ...
		  .input_buffer_sel(2'b00))
		CHANGE_PWR
		 (.oe(tmpOE__CHANGE_PWR_net),
		  .y({1'b0}),
		  .fb({tmpFB_0__CHANGE_PWR_net[0:0]}),
		  .io({tmpIO_0__CHANGE_PWR_net[0:0]}),
		  .siovref(tmpSIOVREF__CHANGE_PWR_net),
		  .interrupt({tmpINTERRUPT_0__CHANGE_PWR_net[0:0]}),
		  .in_clock({1'b0}),
		  .in_clock_en({1'b1}),
		  .in_reset({1'b0}),
		  .out_clock({1'b0}),
	...
	assign tmpOE__CHANGE_PWR_net = (`CYDEV_CHIP_MEMBER_USED == `CYDEV_CHIP_MEMBER_3A && `CYDEV_CHIP_REVISION_USED < `CYDEV_CHIP_REVISION_3A_ES3) ? ~{1'b1} : {1'b1};

	wire [0:0] tmpOE__ECDR_A_net;
	wire [0:0] tmpIO_0__ECDR_A_net;
	wire [0:0] tmpINTERRUPT_0__ECDR_A_net;
	electrical [0:0] tmpSIOVREF__ECDR_A_net;
	...
	cy_psoc3_pins_v1_10
		#(.id("8d318d8b-cf7b-4b6b-b02c-ab1c5c49d0ba"),
		  ...
		  .input_buffer_sel(2'b00))
		ECDR_A
		 (.oe(tmpOE__ECDR_A_net),
		  .y({1'b0}),
		  .fb({Net_5808}),
		  .io({tmpIO_0__ECDR_A_net[0:0]}),
		  .siovref(tmpSIOVREF__ECDR_A_net),
		  .interrupt({tmpINTERRUPT_0__ECDR_A_net[0:0]}),
		  .in_clock({1'b0}),
		  .in_clock_en({1'b1}),
		  .in_reset({1'b0}),
		  .out_clock({1'b0}),
	...
	assign tmpOE__ECDR_A_net = (`CYDEV_CHIP_MEMBER_USED == `CYDEV_CHIP_MEMBER_3A && `CYDEV_CHIP_REVISION_USED < `CYDEV_CHIP_REVISION_3A_ES3) ? ~{1'b1} : {1'b1};
    ...
    QuadDec_v3_0_8 ECDR (
        ...
        .clock(Net_15638),
        .interrupt(Net_5806));
    defparam ECDR.CounterResolution = 1;
    defparam ECDR.UsingGlitchFiltering = 1;
    defparam ECDR.UsingIndexInput = 0;

	wire [0:0] tmpOE__ECDR_B_net;
	wire [0:0] tmpIO_0__ECDR_B_net;
	wire [0:0] tmpINTERRUPT_0__ECDR_B_net;
	electrical [0:0] tmpSIOVREF__ECDR_B_net;

	cy_psoc3_pins_v1_10
		#(.id("43698a5b-bf2c-40c9-868b-6ba2be7eb1d6"),
		  .drive_mode(3'b001),
		  .ibuf_enabled(1'b1),
		  .init_dr_st(1'b0),
		  .input_clk_en(0),
		  ...
		  .input_buffer_sel(2'b00))
		ECDR_B
		 (.oe(tmpOE__ECDR_B_net),
		  .y({1'b0}),
		  .fb({Net_5798}),
		  .io({tmpIO_0__ECDR_B_net[0:0]}),
		  .siovref(tmpSIOVREF__ECDR_B_net),
		  .interrupt({tmpINTERRUPT_0__ECDR_B_net[0:0]}),
		  .in_clock({1'b0}),
		  .in_clock_en({1'b1}),
		  .in_reset({1'b0}),
		  .out_clock({1'b0}),
	...
	assign tmpOE__ECDR_B_net = (`CYDEV_CHIP_MEMBER_USED == `CYDEV_CHIP_MEMBER_3A && `CYDEV_CHIP_REVISION_USED < `CYDEV_CHIP_REVISION_3A_ES3) ? ~{1'b1} : {1'b1};

    PWM_v3_30_9 PWM_LED_1 (
        .reset(Net_9655),
        .clock(Net_13781),
        .tc(Net_15500),
        .pwm1(Net_15501),
    ...
    PWM_v3_30_10 PWM_LED_3 (
        ...
        .ph1(Net_15518),
        .ph2(Net_15519));
    defparam PWM_LED_3.Resolution = 16;
    ...
    PWM_v3_30_11 PWM_LED_2 (
        ...
        .ph1(Net_15528),
        .ph2(Net_15529));
    defparam PWM_LED_2.Resolution = 16;
    ...
    PWM_v3_30_12 PWM_LED_4 (
        ...
        .ph1(Net_15538),
        .ph2(Net_15539));
    defparam PWM_LED_4.Resolution = 16;

    UART_v2_50_13 UART_CH (
        .cts_n(1'b0),
        .tx(Net_15699),
        .rts_n(Net_15700),
        .tx_en(Net_15701),
        ...
        .reset(1'b0),
        .rx(Net_15645),
        .tx_interrupt(Net_15704),
        .rx_interrupt(Net_15647),
        .tx_data(Net_15705),
        .tx_clk(Net_15706),
        .rx_data(Net_15707),
        .rx_clk(Net_15708));
    defparam UART_CH.Address1 = 0;
    defparam UART_CH.Address2 = 0;
    defparam UART_CH.EnIntRXInterrupt = 0;
    defparam UART_CH.EnIntTXInterrupt = 0;
    defparam UART_CH.FlowControl = 0;
    defparam UART_CH.HalfDuplexEn = 0;
    defparam UART_CH.HwTXEnSignal = 1;
    defparam UART_CH.NumDataBits = 8;
    defparam UART_CH.NumStopBits = 1;
    defparam UART_CH.ParityType = 0;
    defparam UART_CH.RXEnable = 1;
    defparam UART_CH.TXEnable = 1;

	wire [0:0] tmpOE__Rx_CH_net;
	wire [0:0] tmpIO_0__Rx_CH_net;
	wire [0:0] tmpINTERRUPT_0__Rx_CH_net;
	electrical [0:0] tmpSIOVREF__Rx_CH_net;

	cy_psoc3_pins_v1_10
		#(.id("7261c5e4-34df-473c-915a-299accd4f6f4"),
		  .drive_mode(3'b001),
		  .ibuf_enabled(1'b1),
		  .init_dr_st(1'b0),
		  .input_clk_en(0),
		...
		Rx_CH
		 (.oe(tmpOE__Rx_CH_net),
		  .y({1'b0}),
		  .fb({Net_15645}),
		  .io({tmpIO_0__Rx_CH_net[0:0]}),
		  .siovref(tmpSIOVREF__Rx_CH_net),
		  .interrupt({tmpINTERRUPT_0__Rx_CH_net[0:0]}),
		  .in_clock({1'b0}),
		  .in_clock_en({1'b1}),
		  .in_reset({1'b0}),
		  .out_clock({1'b0}),
	...
	assign tmpOE__Rx_CH_net = (`CYDEV_CHIP_MEMBER_USED == `CYDEV_CHIP_MEMBER_3A && `CYDEV_CHIP_REVISION_USED < `CYDEV_CHIP_REVISION_3A_ES3) ? ~{1'b1} : {1'b1};


	cy_isr_v1_0
		#(.int_type(2'b10))
		isr_rx_ch
		 (.int_signal(Net_15647));


	wire [0:0] tmpOE__M_PWR_net;
	wire [0:0] tmpFB_0__M_PWR_net;
	wire [0:0] tmpIO_0__M_PWR_net;
	wire [0:0] tmpINTERRUPT_0__M_PWR_net;
	electrical [0:0] tmpSIOVREF__M_PWR_net;

	cy_psoc3_pins_v1_10
		#(.id("50ec7e47-0286-4e33-a95e-d6cee8325721"),
		  .drive_mode(3'b110),
		  .ibuf_enabled(1'b1),
		  .init_dr_st(1'b0),
		  .input_clk_en(0),
		...
		M_PWR
		 (.oe(tmpOE__M_PWR_net),
		  .y({1'b0}),
		  .fb({tmpFB_0__M_PWR_net[0:0]}),
		  .io({tmpIO_0__M_PWR_net[0:0]}),
		  .siovref(tmpSIOVREF__M_PWR_net),
		  .interrupt({tmpINTERRUPT_0__M_PWR_net[0:0]}),
		  .in_clock({1'b0}),
		  .in_clock_en({1'b1}),
		  .in_reset({1'b0}),
		  .out_clock({1'b0}),
	...
	assign tmpOE__M_PWR_net = (`CYDEV_CHIP_MEMBER_USED == `CYDEV_CHIP_MEMBER_3A && `CYDEV_CHIP_REVISION_USED < `CYDEV_CHIP_REVISION_3A_ES3) ? ~{1'b1} : {1'b1};

	wire [0:0] tmpOE__M_UP_net;
	wire [0:0] tmpFB_0__M_UP_net;
	wire [0:0] tmpIO_0__M_UP_net;
	wire [0:0] tmpINTERRUPT_0__M_UP_net;
	electrical [0:0] tmpSIOVREF__M_UP_net;

	cy_psoc3_pins_v1_10
		#(.id("be15ddce-e13b-4ca1-992e-92d4f4fb188c"),
		  .drive_mode(3'b110),
		  .ibuf_enabled(1'b1),
		  .init_dr_st(1'b0),
		  .input_clk_en(0),
		...
		M_UP
		 (.oe(tmpOE__M_UP_net),
		  .y({1'b0}),
		  .fb({tmpFB_0__M_UP_net[0:0]}),
		  .io({tmpIO_0__M_UP_net[0:0]}),
		  .siovref(tmpSIOVREF__M_UP_net),
		  .interrupt({tmpINTERRUPT_0__M_UP_net[0:0]}),
		  .in_clock({1'b0}),
		  .in_clock_en({1'b1}),
		  .in_reset({1'b0}),
		  .out_clock({1'b0}),
	...
	assign tmpOE__M_UP_net = (`CYDEV_CHIP_MEMBER_USED == `CYDEV_CHIP_MEMBER_3A && `CYDEV_CHIP_REVISION_USED < `CYDEV_CHIP_REVISION_3A_ES3) ? ~{1'b1} : {1'b1};

	wire [0:0] tmpOE__M_DOWN_net;
	wire [0:0] tmpFB_0__M_DOWN_net;
	wire [0:0] tmpIO_0__M_DOWN_net;
	wire [0:0] tmpINTERRUPT_0__M_DOWN_net;
	electrical [0:0] tmpSIOVREF__M_DOWN_net;

	cy_psoc3_pins_v1_10
		#(.id("3ab332c3-9ffb-40ac-910a-bfa8708e427a"),
		  .drive_mode(3'b110),
		  .ibuf_enabled(1'b1),
		  .init_dr_st(1'b0),
		  .input_clk_en(0),
		  ...
		  .input_buffer_sel(2'b00))
		M_DOWN
		 (.oe(tmpOE__M_DOWN_net),
		  .y({1'b0}),
		  .fb({tmpFB_0__M_DOWN_net[0:0]}),
		  .io({tmpIO_0__M_DOWN_net[0:0]}),
		  .siovref(tmpSIOVREF__M_DOWN_net),
		  .interrupt({tmpINTERRUPT_0__M_DOWN_net[0:0]}),
		  .in_clock({1'b0}),
		  .in_clock_en({1'b1}),
		  .in_reset({1'b0}),
		  .out_clock({1'b0}),
	...
	assign tmpOE__M_DOWN_net = (`CYDEV_CHIP_MEMBER_USED == `CYDEV_CHIP_MEMBER_3A && `CYDEV_CHIP_REVISION_USED < `CYDEV_CHIP_REVISION_3A_ES3) ? ~{1'b1} : {1'b1};

	wire [0:0] tmpOE__M_ZERO_net;
	wire [0:0] tmpFB_0__M_ZERO_net;
	wire [0:0] tmpIO_0__M_ZERO_net;
	wire [0:0] tmpINTERRUPT_0__M_ZERO_net;
	electrical [0:0] tmpSIOVREF__M_ZERO_net;

	cy_psoc3_pins_v1_10
		#(.id("3876e694-47bb-461d-96d2-eec2ddc32396"),
		  .drive_mode(3'b110),
		  .ibuf_enabled(1'b1),
		  .init_dr_st(1'b0),
		  .input_clk_en(0),
		  ...
		  .input_buffer_sel(2'b00))
		M_ZERO
		 (.oe(tmpOE__M_ZERO_net),
		  .y({1'b0}),
		  .fb({tmpFB_0__M_ZERO_net[0:0]}),
		  .io({tmpIO_0__M_ZERO_net[0:0]}),
		  .siovref(tmpSIOVREF__M_ZERO_net),
		  .interrupt({tmpINTERRUPT_0__M_ZERO_net[0:0]}),
		  .in_clock({1'b0}),
		  .in_clock_en({1'b1}),
		  .in_reset({1'b0}),
		  .out_clock({1'b0}),
	...
	assign tmpOE__M_ZERO_net = (`CYDEV_CHIP_MEMBER_USED == `CYDEV_CHIP_MEMBER_3A && `CYDEV_CHIP_REVISION_USED < `CYDEV_CHIP_REVISION_3A_ES3) ? ~{1'b1} : {1'b1};

	wire [0:0] tmpOE__PUSH_DIR_net;
	wire [0:0] tmpFB_0__PUSH_DIR_net;
	wire [0:0] tmpIO_0__PUSH_DIR_net;
	wire [0:0] tmpINTERRUPT_0__PUSH_DIR_net;
	electrical [0:0] tmpSIOVREF__PUSH_DIR_net;

	cy_psoc3_pins_v1_10
		#(.id("f21249a1-8cb5-45aa-b8b2-eb78022a78f6"),
		  .drive_mode(3'b110),
		  .ibuf_enabled(1'b1),
		  .init_dr_st(1'b1),
		  .input_clk_en(0),
		  ...
		  .input_buffer_sel(2'b00))
		PUSH_DIR
		 (.oe(tmpOE__PUSH_DIR_net),
		  .y({1'b0}),
		  .fb({tmpFB_0__PUSH_DIR_net[0:0]}),
		  .io({tmpIO_0__PUSH_DIR_net[0:0]}),
		  .siovref(tmpSIOVREF__PUSH_DIR_net),
		  .interrupt({tmpINTERRUPT_0__PUSH_DIR_net[0:0]}),
		  .in_clock({1'b0}),
		  .in_clock_en({1'b1}),
		  .in_reset({1'b0}),
		  .out_clock({1'b0}),
	...
	assign tmpOE__PUSH_DIR_net = (`CYDEV_CHIP_MEMBER_USED == `CYDEV_CHIP_MEMBER_3A && `CYDEV_CHIP_REVISION_USED < `CYDEV_CHIP_REVISION_3A_ES3) ? ~{1'b1} : {1'b1};

	wire [0:0] tmpOE__PUSH_EN_net;
	wire [0:0] tmpFB_0__PUSH_EN_net;
	wire [0:0] tmpIO_0__PUSH_EN_net;
	wire [0:0] tmpINTERRUPT_0__PUSH_EN_net;
	electrical [0:0] tmpSIOVREF__PUSH_EN_net;

	cy_psoc3_pins_v1_10
		#(.id("cea0a699-824a-40d0-8364-993e52641799"),
		  .drive_mode(3'b110),
		  .ibuf_enabled(1'b1),
		  .init_dr_st(1'b1),
		  .input_clk_en(0),
		  ...
		  .input_buffer_sel(2'b00))
		PUSH_EN
		 (.oe(tmpOE__PUSH_EN_net),
		  .y({1'b0}),
		  .fb({tmpFB_0__PUSH_EN_net[0:0]}),
		  .io({tmpIO_0__PUSH_EN_net[0:0]}),
		  .siovref(tmpSIOVREF__PUSH_EN_net),
		  .interrupt({tmpINTERRUPT_0__PUSH_EN_net[0:0]}),
		  .in_clock({1'b0}),
		  .in_clock_en({1'b1}),
		  .in_reset({1'b0}),
		  .out_clock({1'b0}),
	...
	assign tmpOE__PUSH_EN_net = (`CYDEV_CHIP_MEMBER_USED == `CYDEV_CHIP_MEMBER_3A && `CYDEV_CHIP_REVISION_USED < `CYDEV_CHIP_REVISION_3A_ES3) ? ~{1'b1} : {1'b1};

	wire [0:0] tmpOE__PUSH_STEP_net;
	wire [0:0] tmpFB_0__PUSH_STEP_net;
	wire [0:0] tmpIO_0__PUSH_STEP_net;
	wire [0:0] tmpINTERRUPT_0__PUSH_STEP_net;
	electrical [0:0] tmpSIOVREF__PUSH_STEP_net;

	cy_psoc3_pins_v1_10
		#(.id("9fa44ed1-b709-46cb-ba20-550a6b101167"),
		  .drive_mode(3'b110),
		  .ibuf_enabled(1'b1),
		  .init_dr_st(1'b1),
		  .input_clk_en(0),
		  ...
		  .input_buffer_sel(2'b00))
		PUSH_STEP
		 (.oe(tmpOE__PUSH_STEP_net),
		  .y({1'b0}),
		  .fb({tmpFB_0__PUSH_STEP_net[0:0]}),
		  .io({tmpIO_0__PUSH_STEP_net[0:0]}),
		  .siovref(tmpSIOVREF__PUSH_STEP_net),
		  .interrupt({tmpINTERRUPT_0__PUSH_STEP_net[0:0]}),
		  .in_clock({1'b0}),
		  .in_clock_en({1'b1}),
		  .in_reset({1'b0}),
		  .out_clock({1'b0}),
	...
	assign tmpOE__PUSH_STEP_net = (`CYDEV_CHIP_MEMBER_USED == `CYDEV_CHIP_MEMBER_3A && `CYDEV_CHIP_REVISION_USED < `CYDEV_CHIP_REVISION_3A_ES3) ? ~{1'b1} : {1'b1};
	...
	cy_psoc3_pins_v1_10
		#(.id("5dce6934-127c-4de4-bb04-ca4a79344834"),
		  .drive_mode(3'b110),
		  .ibuf_enabled(1'b1),
		  .init_dr_st(1'b0),
		  .input_clk_en(0),
	...
	cy_psoc3_pins_v1_10
		#(.id("2a298457-a6bb-4a7b-8c9d-81aebcb3ee57"),
		  .drive_mode(3'b110),
		  .ibuf_enabled(1'b1),
		  .init_dr_st(1'b0),
		  .input_clk_en(0),
	...
	cy_psoc3_pins_v1_10
		#(.id("977b361f-cce6-4a6f-ac8d-0dd2375cf569"),
		  .drive_mode(3'b110),
		  .ibuf_enabled(1'b1),
		  .init_dr_st(1'b0),
		  .input_clk_en(0),
	...
	cy_psoc3_pins_v1_10
		#(.id("4b758639-3a17-4bed-9a3d-3ae56aa611b7"),
		  .drive_mode(3'b110),
		  .ibuf_enabled(1'b1),
		  .init_dr_st(1'b0),
		  .input_clk_en(0),
	...
	wire [0:0] tmpOE__PWM_RIGHT_EN_net;
	wire [0:0] tmpFB_0__PWM_RIGHT_EN_net;
	wire [0:0] tmpIO_0__PWM_RIGHT_EN_net;
	wire [0:0] tmpINTERRUPT_0__PWM_RIGHT_EN_net;
	electrical [0:0] tmpSIOVREF__PWM_RIGHT_EN_net;

	cy_psoc3_pins_v1_10
		#(.id("bc1fc7c0-1de1-4186-8412-b1673385408c"),
		  .drive_mode(3'b110),
		  .ibuf_enabled(1'b1),
		  .init_dr_st(1'b0),
		  .input_clk_en(0),
		  ...
		  .input_buffer_sel(2'b00))
		PWM_RIGHT_EN
		 (.oe(tmpOE__PWM_RIGHT_EN_net),
		  .y({1'b0}),
		  .fb({tmpFB_0__PWM_RIGHT_EN_net[0:0]}),
		  .io({tmpIO_0__PWM_RIGHT_EN_net[0:0]}),
		  .siovref(tmpSIOVREF__PWM_RIGHT_EN_net),
		  .interrupt({tmpINTERRUPT_0__PWM_RIGHT_EN_net[0:0]}),
		  .in_clock({1'b0}),
		  .in_clock_en({1'b1}),
		  .in_reset({1'b0}),
		  .out_clock({1'b0}),
	...
	assign tmpOE__PWM_RIGHT_EN_net = (`CYDEV_CHIP_MEMBER_USED == `CYDEV_CHIP_MEMBER_3A && `CYDEV_CHIP_REVISION_USED < `CYDEV_CHIP_REVISION_3A_ES3) ? ~{1'b1} : {1'b1};

	wire [0:0] tmpOE__PWM_LEFT_EN_net;
	wire [0:0] tmpFB_0__PWM_LEFT_EN_net;
	wire [0:0] tmpIO_0__PWM_LEFT_EN_net;
	wire [0:0] tmpINTERRUPT_0__PWM_LEFT_EN_net;
	electrical [0:0] tmpSIOVREF__PWM_LEFT_EN_net;

	cy_psoc3_pins_v1_10
		#(.id("9bf78517-3675-48af-9a0a-9ca87e7f9ef7"),
		  .drive_mode(3'b110),
		  .ibuf_enabled(1'b1),
		  .init_dr_st(1'b0),
		  .input_clk_en(0),
		  ...
		  .input_buffer_sel(2'b00))
		PWM_LEFT_EN
		 (.oe(tmpOE__PWM_LEFT_EN_net),
		  .y({1'b0}),
		  .fb({tmpFB_0__PWM_LEFT_EN_net[0:0]}),
		  .io({tmpIO_0__PWM_LEFT_EN_net[0:0]}),
		  .siovref(tmpSIOVREF__PWM_LEFT_EN_net),
		  .interrupt({tmpINTERRUPT_0__PWM_LEFT_EN_net[0:0]}),
		  .in_clock({1'b0}),
		  .in_clock_en({1'b1}),
		  .in_reset({1'b0}),
		  .out_clock({1'b0}),
	...
	assign tmpOE__PWM_LEFT_EN_net = (`CYDEV_CHIP_MEMBER_USED == `CYDEV_CHIP_MEMBER_3A && `CYDEV_CHIP_REVISION_USED < `CYDEV_CHIP_REVISION_3A_ES3) ? ~{1'b1} : {1'b1};
