...
#if (!PWM_LED_UsingFixedFunction)
    uint16   PWM_LED_ReadCounter(void) ;
    uint16 PWM_LED_ReadCapture(void) ;

    #if (PWM_LED_UseStatus)
            void PWM_LED_ClearFIFO(void) ;
    #endif /* (PWM_LED_UseStatus) */

    void    PWM_LED_WriteCounter(uint16 counter)
            ;
#endif /* (!PWM_LED_UsingFixedFunction) */

void    PWM_LED_WritePeriod(uint16 period)
        ;
uint16 PWM_LED_ReadPeriod(void) ;

#if (PWM_LED_UseOneCompareMode)
    void    PWM_LED_WriteCompare(uint16 compare)
            ;
    uint16 PWM_LED_ReadCompare(void) ;
#else
    void    PWM_LED_WriteCompare1(uint16 compare)
            ;
    uint16 PWM_LED_ReadCompare1(void) ;
    void    PWM_LED_WriteCompare2(uint16 compare)
            ;
    uint16 PWM_LED_ReadCompare2(void) ;
#endif /* (PWM_LED_UseOneCompareMode) */
...
******************************** */
   ...
   #define PWM_LED_RT1_PTR                 ( (reg8 *)  PWM_LED_PWMHW__RT1)
       ...
       #if(PWM_LED_PWMModeIsCenterAligned)
           #define PWM_LED_PERIOD_LSB      (*(reg8 *)  PWM_LED_PWMUDB_sP16_pwmdp_u0__D1_REG)
           #define PWM_LED_PERIOD_LSB_PTR  ((reg8 *)   PWM_LED_PWMUDB_sP16_pwmdp_u0__D1_REG)
       #else
           #define PWM_LED_PERIOD_LSB      (*(reg8 *)  PWM_LED_PWMUDB_sP16_pwmdp_u0__F0_REG)
           #define PWM_LED_PERIOD_LSB_PTR  ((reg8 *)   PWM_LED_PWMUDB_sP16_pwmdp_u0__F0_REG)
       #endif /* (PWM_LED_PWMModeIsCenterAligned) */

       #define PWM_LED_COMPARE1_LSB        (*(reg8 *)  PWM_LED_PWMUDB_sP16_pwmdp_u0__D0_REG)
       #define PWM_LED_COMPARE1_LSB_PTR    ((reg8 *)   PWM_LED_PWMUDB_sP16_pwmdp_u0__D0_REG)
       #define PWM_LED_COMPARE2_LSB        (*(reg8 *)  PWM_LED_PWMUDB_sP16_pwmdp_u0__D1_REG)
       #define PWM_LED_COMPARE2_LSB_PTR    ((reg8 *)   PWM_LED_PWMUDB_sP16_pwmdp_u0__D1_REG)
       #define PWM_LED_COUNTERCAP_LSB      (*(reg8 *)  PWM_LED_PWMUDB_sP16_pwmdp_u0__A1_REG)
       #define PWM_LED_COUNTERCAP_LSB_PTR  ((reg8 *)   PWM_LED_PWMUDB_sP16_pwmdp_u0__A1_REG)
       #define PWM_LED_COUNTER_LSB         (*(reg8 *)  PWM_LED_PWMUDB_sP16_pwmdp_u0__A0_REG)
       #define PWM_LED_COUNTER_LSB_PTR     ((reg8 *)   PWM_LED_PWMUDB_sP16_pwmdp_u0__A0_REG)
       #define PWM_LED_CAPTURE_LSB         (*(reg8 *)  PWM_LED_PWMUDB_sP16_pwmdp_u0__F1_REG)
       #define PWM_LED_CAPTURE_LSB_PTR     ((reg8 *)   PWM_LED_PWMUDB_sP16_pwmdp_u0__F1_REG)

   #else
        #if(CY_PSOC3) /* 8-bit address space */
            #if(PWM_LED_PWMModeIsCenterAligned)
               #define PWM_LED_PERIOD_LSB      (*(reg16 *) PWM_LED_PWMUDB_sP16_pwmdp_u0__D1_REG)
               #define PWM_LED_PERIOD_LSB_PTR  ((reg16 *)  PWM_LED_PWMUDB_sP16_pwmdp_u0__D1_REG)
            #else
               #define PWM_LED_PERIOD_LSB      (*(reg16 *) PWM_LED_PWMUDB_sP16_pwmdp_u0__F0_REG)
               #define PWM_LED_PERIOD_LSB_PTR  ((reg16 *)  PWM_LED_PWMUDB_sP16_pwmdp_u0__F0_REG)
            #endif /* (PWM_LED_PWMModeIsCenterAligned) */

            #define PWM_LED_COMPARE1_LSB       (*(reg16 *) PWM_LED_PWMUDB_sP16_pwmdp_u0__D0_REG)
            #define PWM_LED_COMPARE1_LSB_PTR   ((reg16 *)  PWM_LED_PWMUDB_sP16_pwmdp_u0__D0_REG)
            #define PWM_LED_COMPARE2_LSB       (*(reg16 *) PWM_LED_PWMUDB_sP16_pwmdp_u0__D1_REG)
            #define PWM_LED_COMPARE2_LSB_PTR   ((reg16 *)  PWM_LED_PWMUDB_sP16_pwmdp_u0__D1_REG)
            #define PWM_LED_COUNTERCAP_LSB     (*(reg16 *) PWM_LED_PWMUDB_sP16_pwmdp_u0__A1_REG)
            #define PWM_LED_COUNTERCAP_LSB_PTR ((reg16 *)  PWM_LED_PWMUDB_sP16_pwmdp_u0__A1_REG)
            #define PWM_LED_COUNTER_LSB        (*(reg16 *) PWM_LED_PWMUDB_sP16_pwmdp_u0__A0_REG)
            #define PWM_LED_COUNTER_LSB_PTR    ((reg16 *)  PWM_LED_PWMUDB_sP16_pwmdp_u0__A0_REG)
            #define PWM_LED_CAPTURE_LSB        (*(reg16 *) PWM_LED_PWMUDB_sP16_pwmdp_u0__F1_REG)
            #define PWM_LED_CAPTURE_LSB_PTR    ((reg16 *)  PWM_LED_PWMUDB_sP16_pwmdp_u0__F1_REG)
        #else
            #if(PWM_LED_PWMModeIsCenterAligned)
               #define PWM_LED_PERIOD_LSB      (*(reg16 *) PWM_LED_PWMUDB_sP16_pwmdp_u0__16BIT_D1_REG)
               #define PWM_LED_PERIOD_LSB_PTR  ((reg16 *)  PWM_LED_PWMUDB_sP16_pwmdp_u0__16BIT_D1_REG)
            #else
               #define PWM_LED_PERIOD_LSB      (*(reg16 *) PWM_LED_PWMUDB_sP16_pwmdp_u0__16BIT_F0_REG)
               #define PWM_LED_PERIOD_LSB_PTR  ((reg16 *)  PWM_LED_PWMUDB_sP16_pwmdp_u0__16BIT_F0_REG)
            #endif /* (PWM_LED_PWMModeIsCenterAligned) */

            #define PWM_LED_COMPARE1_LSB       (*(reg16 *) PWM_LED_PWMUDB_sP16_pwmdp_u0__16BIT_D0_REG)
            #define PWM_LED_COMPARE1_LSB_PTR   ((reg16 *)  PWM_LED_PWMUDB_sP16_pwmdp_u0__16BIT_D0_REG)
            #define PWM_LED_COMPARE2_LSB       (*(reg16 *) PWM_LED_PWMUDB_sP16_pwmdp_u0__16BIT_D1_REG)
            #define PWM_LED_COMPARE2_LSB_PTR   ((reg16 *)  PWM_LED_PWMUDB_sP16_pwmdp_u0__16BIT_D1_REG)
            #define PWM_LED_COUNTERCAP_LSB     (*(reg16 *) PWM_LED_PWMUDB_sP16_pwmdp_u0__16BIT_A1_REG)
            #define PWM_LED_COUNTERCAP_LSB_PTR ((reg16 *)  PWM_LED_PWMUDB_sP16_pwmdp_u0__16BIT_A1_REG)
            #define PWM_LED_COUNTER_LSB        (*(reg16 *) PWM_LED_PWMUDB_sP16_pwmdp_u0__16BIT_A0_REG)
            #define PWM_LED_COUNTER_LSB_PTR    ((reg16 *)  PWM_LED_PWMUDB_sP16_pwmdp_u0__16BIT_A0_REG)
            #define PWM_LED_CAPTURE_LSB        (*(reg16 *) PWM_LED_PWMUDB_sP16_pwmdp_u0__16BIT_F1_REG)
            #define PWM_LED_CAPTURE_LSB_PTR    ((reg16 *)  PWM_LED_PWMUDB_sP16_pwmdp_u0__16BIT_F1_REG)
        #endif /* (CY_PSOC3) */

       #define PWM_LED_AUX_CONTROLDP1          (*(reg8 *)  PWM_LED_PWMUDB_sP16_pwmdp_u1__DP_AUX_CTL_REG)
       #define PWM_LED_AUX_CONTROLDP1_PTR      ((reg8 *)   PWM_LED_PWMUDB_sP16_pwmdp_u1__DP_AUX_CTL_REG)

   #endif /* (PWM_LED_Resolution == 8) */

   #define PWM_LED_COUNTERCAP_LSB_PTR_8BIT ( (reg8 *)  PWM_LED_PWMUDB_sP16_pwmdp_u0__A1_REG)
   #define PWM_LED_AUX_CONTROLDP0          (*(reg8 *)  PWM_LED_PWMUDB_sP16_pwmdp_u0__DP_AUX_CTL_REG)
   #define PWM_LED_AUX_CONTROLDP0_PTR      ((reg8 *)   PWM_LED_PWMUDB_sP16_pwmdp_u0__DP_AUX_CTL_REG)
