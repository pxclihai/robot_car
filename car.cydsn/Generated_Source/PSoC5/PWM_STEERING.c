...
void PWM_STEERING_WritePeriod(uint16 period) 
{
    ...
    *******************************************************************************/
                                       ...
                                       
    {
            ...
            #else
                CY_SET_REG16(PWM_STEERING_COMPARE2_LSB_PTR, (compare + 1u));
            #endif /* (PWM_STEERING_UsingFixedFunction) */
    ...
    *******************************************************************************/
    ...
    {
        #if(PWM_STEERING_UsingFixedFunction)
            return ((uint16)CY_GET_REG16(PWM_STEERING_COMPARE1_LSB_PTR));
        #else
            return (CY_GET_REG16(PWM_STEERING_COMPARE1_LSB_PTR));
        #endif /* (PWM_STEERING_UsingFixedFunction) */
    }
    ...
    *******************************************************************************/
    ...
    {
        return (CY_GET_REG16(PWM_STEERING_COMPARE2_LSB_PTR));
    }
...
{
    #if(PWM_STEERING_UsingFixedFunction)
        return ((uint16)CY_GET_REG16(PWM_STEERING_PERIOD_LSB_PTR));
    #else
        return (CY_GET_REG16(PWM_STEERING_PERIOD_LSB_PTR));
    #endif /* (PWM_STEERING_UsingFixedFunction) */
}
