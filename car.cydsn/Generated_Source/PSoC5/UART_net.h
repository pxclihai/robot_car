...
#define UART_net_TX_BUFFER_SIZE                 (4u)
#define UART_net_RX_BUFFER_SIZE                 (4u)
...
#if defined(UART_net_BUART_sCR_SyncCtl_CtrlReg__CONTROL_REG)
    #define UART_net_CONTROL_REG_REMOVED            (0u)
#else
    #define UART_net_CONTROL_REG_REMOVED            (1u)
#endif /* End UART_net_BUART_sCR_SyncCtl_CtrlReg__CONTROL_REG */
...
/* Only if RX is enabled */
        ...
        #define UART_net_EnableRxInt()  CyIntEnable (UART_net_RX_VECT_NUM)
        #define UART_net_DisableRxInt() CyIntDisable(UART_net_RX_VECT_NUM)
...
/* Only if TX is enabled */
        ...
        #define UART_net_EnableTxInt()  CyIntEnable (UART_net_TX_VECT_NUM)
        #define UART_net_DisableTxInt() CyIntDisable(UART_net_TX_VECT_NUM)
        #define UART_net_SetPendingTxInt() CyIntSetPending(UART_net_TX_VECT_NUM)
        #define UART_net_ClearPendingTxInt() CyIntClearPending(UART_net_TX_VECT_NUM)
...
/* Communication bootloader APIs */
    ...
    #define UART_net_PACKET_EOP         (0x17u) /* End of packet defined by bootloader */
    #define UART_net_WAIT_EOP_DELAY     (5u)    /* Additional 5ms to wait for End of packet */
    #define UART_net_BL_CHK_DELAY_MS    (1u)    /* Time Out quantity equal 1mS */
...
#define UART_net_BIT_CENTER                         (UART_net_OVER_SAMPLE_COUNT - 2u)
...
extern uint8 UART_net_initVar;
    ...
    extern volatile uint8 UART_net_txBuffer[UART_net_TX_BUFFER_SIZE];
    ...
    extern uint8 UART_net_errorStatus;
    extern volatile uint8 UART_net_rxBuffer[UART_net_RX_BUFFER_SIZE];
...
#if (UART_net_RXHW_ADDRESS_ENABLED)
    #define UART_net_RX_ADDRESS_MODE    (0u)
    #define UART_net_RX_HW_ADDRESS1     (0u)
    #define UART_net_RX_HW_ADDRESS2     (0u)
#endif /* (UART_net_RXHW_ADDRESS_ENABLED) */
...
#define UART_net_INIT_TX_INTERRUPTS_MASK \
                                  (uint8)((1 << UART_net_TX_STS_COMPLETE_SHIFT) \
...
#ifdef UART_net_BUART_sCR_SyncCtl_CtrlReg__CONTROL_REG
    #define UART_net_CONTROL_REG \
                            (* (reg8 *) UART_net_BUART_sCR_SyncCtl_CtrlReg__CONTROL_REG )
...
#define UART_net_WAIT_1_MS      UART_net_BL_CHK_DELAY_MS   

#define UART_net_TXBUFFERSIZE   UART_net_TX_BUFFER_SIZE
#define UART_net_RXBUFFERSIZE   UART_net_RX_BUFFER_SIZE

#if (UART_net_RXHW_ADDRESS_ENABLED)
    #define UART_net_RXADDRESSMODE  UART_net_RX_ADDRESS_MODE
    #define UART_net_RXHWADDRESS1   UART_net_RX_HW_ADDRESS1
    #define UART_net_RXHWADDRESS2   UART_net_RX_HW_ADDRESS2
